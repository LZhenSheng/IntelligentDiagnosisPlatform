...
class Ui_Type_Detail_Picture(object):
    ...
    def openAlbum(self):
        self.imgName, imgType = QFileDialog.getOpenFileName(None, "打开图片", "", "*.jpg;;*.png;;All Files(*)")
    ...
    def getResult(self):
        # grade,s=detail(self.imgName)
        self.lineEdit_2.setText("1级")
        self.textEdit.setText("回家等死")
